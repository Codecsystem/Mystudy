...
$$
F(x)
= \frac{a_1}{1^x} + \frac{a_2}{2^x} + \frac{a_3}{3^x} + \cdots
...
$$
\begin{aligned}
\left(\sum_{i=1}^{\infty} \frac{a_i}{i^x}\right)
\left(\sum_{j=1}^{\infty} \frac{b_j}{j^x}\right)
...
| 项 | 系数 |
|---|---|
| $\dfrac{1}{4^x}$ | $a_1b_4 + a_2b_2 + a_4b_1$ |
| $\dfrac{1}{6^x}$ | $a_1b_6 + a_2b_3 + a_3b_2 + a_6b_1$ |
...
$$
\frac{0}{12}, \frac{1}{12}, \frac{2}{12}, \frac{3}{12},
